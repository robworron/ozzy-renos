...
const Contact = () => {
  ...
  return (
    <>
      <Head>
        <title>Contact | Ozzy Renos</title>
        <meta
          name="description"
          content="Contact Ozzy Renos for your renovation needs in the Niagara Region."
        />
      </Head>
        ...
        <section className="flex flex-col items-center w-full p-6 lg:p-8 my-10 bg-[var(--black)] text-white shadow-2xl">
          <article className="w-full max-w-[1200px] text-3xl md:text-4xl lg:text-6xl">
            ...
            <p className="my-8 text-sm md:text-base lg:text-xl">
              ...
              bring your vision to life. Whether you have questions, need a
              quote, or want to discuss your ideas, our team is just a message
              away. Reach out to us by phone, email, or simply fill out the
              contact form below — whatever&apos;s most convenient for you.
              We&apos;re happy to chat, offer guidance, and schedule a
              consultation to get things rolling. Let&apos;s build something
              great together.
            </p>
          </article>
        </section>
        <section className="flex flex-col-reverse md:flex-row justify-center items-center w-full max-w-[1200px]">
          <aside className={infoSectionStyles}>
            ...
            <iframe
              ...
              title="Google Maps Location of Ozzy Renos"
              aria-label="Google Maps Location of Ozzy Renos"
              loading="lazy"
