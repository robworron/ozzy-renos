...
const Contact = () => {
  ...
  return (
    <main className="flex flex-col justify-start min-h-[100vh]">
      <section className="flex flex-col items-center w-full p-8 my-10 bg-[var(--black)] text-white shadow-2xl">
        <article className="w-full max-w-[1200px] text-3xl">
      ...
      <section className="flex flex-row justify-center items-center w-full max-w-[1200px] mt-10 mb-20">
        <aside className={infoSectionStyles}>
          ...
          <iframe
            ...
            loading="lazy"
            className="w-[60%] h-[1200px] max-h-[250px] pt-8 border-0"
          ></iframe>
        </aside>
