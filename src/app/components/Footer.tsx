...
const Footer = () => {
  return (
    <div className="flex flex-col justify-center items-center w-full min-h-[280px] mt-24 py-6 bg-[var(--black)] text-white">
      <div className="flex flex-col md:flex-row justify-around gap-4 w-full max-w-[1200px] px-4">
        <InfoCard footer />
        <iframe
          ...
          loading="lazy"
          className="w-full md:w-[40%] h-full max-w-[400px] max-h-[250px] rounded-lg"
        ></iframe>
      </div>
